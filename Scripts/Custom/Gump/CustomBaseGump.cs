...
{
	public abstract class CustomBaseGump : Gump
	{
		...
		public CustomBaseGump(string titre, int largeur, int hauteur)
			: this(titre, largeur, hauteur, false)
		{

		}

		public CustomBaseGump(string titre, int largeur, int hauteur, bool Background)
		...
		public void CheckBoxButton(int x, int y, int id, bool Check, string text)
		{
			...
			AddHtmlText(x + 20, y - 3, DefaultHtmlLength, text);
		...
		public void AddHtmlText(int x, int y, int largeur, string texte)
		{
		...
		public void AddHtmlText(int x, int y, int largeur, int hauteur, string texte)
		{
			//AddHtml(x, y, largeur, 20, String.Concat("<span color=#241b0d style='font-family:uni0;'>", texte, "</span>"), false, false);
		...
		public void AddSection(int x, int y, int largeur, int hauteur, string titre, string description, string[] texte)
		{
			...
			{
				AddHtmlText(x + 15, (y + 43) + hauteur + (i * 20), largeur - 35, texte[i]);
			}
		}
